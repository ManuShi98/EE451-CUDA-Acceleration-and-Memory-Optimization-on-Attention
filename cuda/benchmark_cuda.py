...
for multiply_factor in range(1, 6):
    q = torch.randn(options.batch_size*multiply_factor, options.head_num, options.token_num, options.features, **kwargs)
    k = torch.randn(options.batch_size*multiply_factor, options.head_num, options.token_num, options.features, **kwargs)
    v = torch.randn(options.batch_size*multiply_factor, options.head_num, options.token_num, options.features, **kwargs)
